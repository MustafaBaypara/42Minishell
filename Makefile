...
CFILES = srcs/minishell.c srcs/tools/garbagecollector.c srcs/loop.c \
		...
		srcs/builtin/echo.c srcs/builtin/env.c srcs/builtin/exit.c srcs/builtin/cd.c srcs/builtin/utils.c \
		srcs/builtin/pwd.c srcs/builtin/export.c srcs/builtin/unset.c srcs/builtin/utils2.c \
